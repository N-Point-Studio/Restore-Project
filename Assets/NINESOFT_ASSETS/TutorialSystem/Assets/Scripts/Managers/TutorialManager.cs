...
namespace NINESOFT.TUTORIAL_SYSTEM
{
    public class TutorialManager : MonoBehaviour
    {
        ...
        public int CurrentTutorialIndex
        {
            ...
            set => currentTutorialIndex = value;
        }
        ...
        private void Start()
        {
            ...
            ShowNextTutorial();
            TutorialEvents.OnTutorialManagerReady?.Invoke();
        }
        ...
        public bool ForceStageStarted(int tutorialIndex, int stageIndex)
        {
            ...
            {
                Tutorials[tutorialIndex].CurrentStageIndex = stageIndex;
                Tutorials[tutorialIndex].CurrentStageIndex++;
                Tutorials[tutorialIndex].Stages[stageIndex].StartTheStage();
            }

            return StageStarted(tutorialIndex, stageIndex);
        }

        public bool ForceStageCompletedd(int tutorialIndex, int stageIndex)
        {
            currentTutorialIndex = tutorialIndex;
            currentTutorialIndex++;
            ...
            return StageCompleted(tutorialIndex, stageIndex);
        }
        ...
        public void SkipTutorial(int tutorialIndex)
        {
            Tutorials[tutorialIndex].SkipTutorial(true);
        }
