...
namespace NINESOFT.TUTORIAL_SYSTEM
{
    public class TutorialModule_PopUp : TutorialModule
    {
        ...
        // cutout
        [SerializeField] private TutorialModule_CutOutMask cutOutMask;
        ...
        private void Update()
        {
            if (cutOutMask != null)
            {
                ...
                RectTransform copyRect = cutOutMask.MaskObject.GetComponent<RectTransform>();

                buttonRect.anchorMin = copyRect.anchorMin;
                buttonRect.anchorMax = copyRect.anchorMax;
                buttonRect.anchoredPosition = copyRect.anchoredPosition;
                buttonRect.sizeDelta = copyRect.sizeDelta;
                buttonRect.pivot = copyRect.pivot;
            }
        }
        ...
        public override IEnumerator ActiveTheModuleEnum()
        {
            ...
            transform.GetChild(1).gameObject.SetActive(!string.IsNullOrEmpty(content));
